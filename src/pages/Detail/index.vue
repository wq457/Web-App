          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item,index) in spuSaleAttrList" :key="item.id">
                ...
                <dd changepirce="0" :class="{active:s.isChecked==1}" v-for="(s,index) in item.spuSaleAttrValueList" :key="s.id" @click="changeChecked(s,item.spuSaleAttrValueList)">{{s.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @blur="changeNum">
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" class="mins" @click="skuNum>1?skuNum--:skuNum=1">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click="goCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      async goCart(){
        try{
           await this.$store.dispatch('sendCart',{skuId:this.skuInfo.id,skuName:this.skuNum})
           this.$router.push({name:'addcartsuccess',query:{skuNum:this.skuNum}})
           sessionStorage.setItem('SHOPCART',JSON.stringify(this.skuInfo))
        }catch(error){
