    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5" @pageChange="pageChange"/>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    attr(item,i){
      let temp = `${item.attrId}:${i}:${item.attrName}`
      if(this.searchParams.props.indexOf(temp)==-1){
             this.searchParams.props.push(temp)
      }
      this.getData()
    },
    removeAttr(index){
